    ...
    <Layout>
      ...
      <div className="relative z-10">
        ...
        <div className="relative overflow-hidden min-h-[100vh] flex items-center">
          ...
          {/* Hero Content */}
          <div className="relative z-30 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 lg:py-32 pointer-events-none">
          ...
          <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-center z-30 pointer-events-none md:hidden">
          ...
          <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-center z-30 pointer-events-none hidden md:block">
            <div className="bg-black/40 backdrop-blur-sm rounded-lg px-3 py-2">
