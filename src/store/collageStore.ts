...
interface CollageStore {
  ...
  updateCollageSettings: (collageId: string, settings: Partial<any>) => Promise<any>;
  uploadPhoto: (collageId: string, file: File) => Promise<any>;
...
export const useCollageStore = create<CollageStore>((set, get) => ({
  ...
  updateCollageSettings: async (collageId: string, settings: Partial<any>) => {
    try {
