/*
  ...
  1. Changes
    - Recreate auth triggers with better error handling
    - Fix user synchronization between auth and public schemas
...
-- Create a more robust user creation function with better error handling
...
-- Create function to handle user updates with better error handling
