/*
  # Fix Collage and Photo Policies

  1. Tables
    - Creates collages and photos tables if they don't exist
    - Sets up foreign key relationships and default values
  
  2. Storage
    - Creates photos storage bucket
