/*
  # Reset and recreate collage tables with policies
  
  1. Changes
    - Clean up existing data and storage
  ...
  2. Security
    ...
    - Set up storage policies with checks
*/
...
-- Recreate policies with existence checks
DO $$ 
BEGIN
  -- Collages policies
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'collages' AND policyname = 'Anyone can create collages') THEN
    CREATE POLICY "Anyone can create collages"
      ON collages FOR INSERT TO public
      WITH CHECK (true);
  END IF;

  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'collages' AND policyname = 'Anyone can view collages') THEN
    CREATE POLICY "Anyone can view collages"
      ON collages FOR SELECT TO public
      USING (true);
  END IF;

  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'collages' AND policyname = 'Anyone can update collages') THEN
    CREATE POLICY "Anyone can update collages"
      ON collages FOR UPDATE TO public
      USING (true);
  END IF;

  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'collages' AND policyname = 'Anyone can delete collages') THEN
  ...
  -- Photos policies
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'photos' AND policyname = 'Anyone can add photos to collages') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'photos' AND policyname = 'Anyone can manage photos') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'collage_settings' AND policyname = 'Anyone can manage collage settings') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'collage_settings' AND policyname = 'Anyone can view collage settings') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'stock_photos' AND policyname = 'Anyone can view stock photos') THEN
  ...
  -- Storage policies
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'objects' AND schemaname = 'storage' AND policyname = 'Anyone can upload photos') THEN
    CREATE POLICY "Anyone can upload photos"
      ON storage.objects FOR INSERT TO public
      WITH CHECK (bucket_id = 'photos');
  END IF;

  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'objects' AND schemaname = 'storage' AND policyname = 'Anyone can view photos') THEN
    CREATE POLICY "Anyone can view photos"
