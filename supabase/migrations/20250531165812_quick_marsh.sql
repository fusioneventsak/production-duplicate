/*
  ...
  1. Changes
    - Clean up existing data and tables
    - Recreate core tables with proper constraints
    - Set up indexes and RLS
    - Create policies for public access
    - Add storage policies with existence checks
    - Create trigger functions for auto-updates
  ...
  3. Security
    ...
    - Public access policies for collage viewing and creation
