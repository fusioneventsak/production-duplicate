/*
  ...
  1. Changes
    - Cleans up existing data and tables
    - Recreates core tables with proper constraints
    - Sets up RLS policies
    - Configures storage policies safely
    - Creates triggers for automatic updates
  
  2. Tables Created
    - collages: Stores collage metadata
    - photos: Stores photo references
    - collage_settings: Stores collage configuration
