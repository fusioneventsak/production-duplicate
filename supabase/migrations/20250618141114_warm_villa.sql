/*
  ...
  1. Changes
    - Adds search_path parameter to all functions
    - Prevents SQL injection vulnerabilities
    - Improves security by setting explicit search path
    
  2. Functions Fixed
    - update_collage_settings_updated_at
    - get_collages_with_photo_count
    - get_user_collages_with_photo_count
    - create_default_collage_settings
    - sync_users
    - update_user_roles_updated_at
    - ensure_score_multiples_of_100
...
-- Fix ensure_score_multiples_of_100 function
...
-- Fix validate_schema_integrity function
...
-- Fix handle_auth_user_created function
